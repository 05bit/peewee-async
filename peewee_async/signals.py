...
class AioModel(_Model):
    ...
    async def aio_save(self, force_insert: bool = False, only: Any = None) -> int | Literal[False]:
        ...
        ret = await super().aio_save(force_insert, only)
    ...
    async def aio_delete_instance(self, recursive: bool = False, delete_nullable: bool = False) -> int:
        ...
        ret = await super().aio_delete_instance(recursive, delete_nullable)
